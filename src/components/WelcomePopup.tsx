  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md mx-auto text-center animate-fadeIn">
      ...
      <p className="text-lg text-gray-700 mb-6">
        Descubra como <span className="font-bold" style={{ color: '#8f339a' }}>acertar 14 pontos na LotoSorte</span> usando a IA da LotoSorte!
      </p>

      <p className="text-base mb-6" style={{ color: '#8f339a' }}>
        Teste já o simulador da LotoSorte 👇
      </p>
      ...
      <div className="text-left mb-8 bg-gray-50 p-4 rounded-lg">
        ...
        <ul className="space-y-2 text-xs text-gray-700">
          ...
          <li>• 2 rodadas com os números da LotoSorte</li>
